...
function onTick()
  ...
  local 
  -- Front Left
  flRot1, -- Upper shoulder
  flRot2, -- Middle shoulder
  flRot3, -- Elbow
  flRot4, -- Wrist
  -- Front Right
  frRot1, -- Upper shoulder
  frRot2, -- Middle shoulder
  frRot3, -- Elbow
  frRot4, -- Wrist

  clock1 = clock1 + gyroSensitivity
  clock2 = clock2 + gyroUpDown

  -- Front left shoulder function
  -- sin(x+pi*1.5)/2*(-y+z)
  -- x= clock1
  -- y= axis1AD
  -- z= axis2WS
  flRot1 = sin(clock1+pi*1.5)/2*(-axis1AD+axis2WS)

  -- Front right shoulder function
  -- sin(x+pi*1.5)/2*(y+z)
  frRot1 = sin(clock1+pi*1.5)/2*(axis1AD+axis2WS)
  ...
  -- Wrist function
  -- sin(x-pi/2)/2+0.5
  flRot4 = sin(clock1-pi/2)/2+0.5
  frRot4 = sin(clock1-pi/2)/2+0.5

  -- Back
  -- Elbow Function
  -- sin(x-pi)/2
  -- x = clock2
  blRot3 = sin(clock2-pi)/2

  -- Wrist Function
  -- (sin(x+(pi/2*(y/abs(y))))/2+0.5)
  -- x = clock2
  -- y = gyroPitch
  blRot4 = (sin(clock2+(pi/2*(gyroPitch/abs(gyroPitch))))/2+0.5)
  brRot4 = blRot4
