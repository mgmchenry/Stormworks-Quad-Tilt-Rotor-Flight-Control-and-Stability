-- Stormworks ArkNet Host Touch Input Processor
-- V 01.01 b0 Michael McHenry 2021-10-23
source={"ArkNetTlm00x01a","repl.it/@mgmchenry"}
...
Outgoing Messages
  Touch Screen Size Info
    4bits[1-4] ScreenID 1-15
    10bits[5-14]
